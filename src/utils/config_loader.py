...
class ConfigManager:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        Raises:
            ConfigError: If YAML is invalid or configuration cannot be loaded
        """
    ...
    def _apply_env_overrides(self, config: Dict[str, Any]) -> None:
        ...
        Environment variable names should use uppercase section names and underscore-delimited keys.
        Examples:
